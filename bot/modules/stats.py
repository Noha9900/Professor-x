*(Rebranded system statistics, updated the GitHub fetch URL to decouple from WZML-X, and added the Professor-X watermark).*
...
from psutil import (
    Process, boot_time, cpu_count, cpu_freq, cpu_percent, disk_io_counters,
    disk_usage, getloadavg, net_io_counters, swap_memory, virtual_memory,
    process_iter, NoSuchProcess, AccessDenied,
)
...
from ..helper.ext_utils.status_utils import (
    get_progress_bar_string, get_readable_file_size, get_readable_time,
)
from ..helper.telegram_helper.filters import CustomFilters
from ..helper.telegram_helper.button_build import ButtonMaker
from ..helper.telegram_helper.message_utils import (
    delete_message, edit_message, send_message,
)
...
async def get_stats(event, key="home"):
    ...
    if key == "home":
        ...
        msg = "⌬ <b><i>Professor-X Bot & OS Statistics!</i></b>"
    elif key == "stbot":
        total, used, free, disk = disk_usage("/")
        swap = swap_memory()
        memory = virtual_memory()
        disk_io = disk_io_counters()
        msg = f"""⌬ <b><i>PROFESSOR-X STATISTICS :</i></b>
...
"""
        ...
        msg = f"""⌬ <b><i>PROFESSOR-X OS SYSTEM :</i></b>
...
"""
        ...
        # REBRANDED PROFESSOR-X FETCH
        official_v = (
            await cmd_exec(
                f"curl -o latestversion.py https://raw.githubusercontent.com/Professor-X/Professor-X-Bot/{Config.UPSTREAM_BRANCH}/bot/version.py -s && python3 latestversion.py && rm latestversion.py",
                True,
            )
        )[0]
...
"""
        ...
        msg = f"""⌬ <b><i>Professor-X Task Limits :</i></b>
│
...
# ... [Keep the rest of the file (bot_stats, stats_pages, etc.) exactly the same] ...
@new_task
