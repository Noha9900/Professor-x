...
class PluginManager:
    ...
    def _refresh_commands(self):
        try:
            ...
            LOGGER.info("Professor-X: Bot commands and help refreshed")
    ...
    async def load_plugin(self, plugin_name: str) -> bool:
        try:
            ...
            if await plugin_instance.on_load():
                ...
                LOGGER.info(f"Professor-X: Plugin {plugin_name} loaded successfully")
                return True
            else:
    ...
    async def unload_plugin(self, plugin_name: str) -> bool:
        try:
            ...
            if await plugin_instance.on_unload():
                ...
                self._refresh_commands()
                LOGGER.info(f"Professor-X: Plugin {plugin_name} unloaded successfully")
                return True
            else:
    ...
    async def enable_plugin(self, plugin_name: str) -> bool:
        try:
            ...
            if await plugin_instance.on_enable():
                ...
                self._refresh_commands()
                LOGGER.info(f"Professor-X: Plugin {plugin_name} enabled")
                return True
            else:
    ...
    async def disable_plugin(self, plugin_name: str) -> bool:
        try:
            ...
            if await plugin_instance.on_disable():
                ...
                self._refresh_commands()
                LOGGER.info(f"Professor-X: Plugin {plugin_name} disabled")
                return True
            else:
